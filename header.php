...
<head>
    ...
    :root {
        ...
        <?php $primary_degrade=get_theme_mod('primary_color_degradate_setting', '#099fdc');
        echo degradate_color($primary_degrade, '--primary-');
        ?>--secondary: <?php echo get_theme_mod('secondary_setting', '#068439');
        ?>;
        --secondary-100: <?php echo get_theme_mod('secondary_100_setting', '#00953A');
        ?>;
        ...
        ?>;
        <?php $secondary_degrade=get_theme_mod('secondary_color_degradate_setting', '#0b6afb');
        ...
        ?>;
        <?php $tertiary_degrade=get_theme_mod('tertiary_color_degradate_setting', '#262c36');
    ...
    .btn-gradient-verde:not(.btn-outline):hover,
    .btn-gradient-verde:not(.btn-outline).hover {
    ...
    .btn-gradient-azul:not(.btn-outline):hover,
    .btn-gradient-azul:not(.btn-outline).hover {
