        ...
        <div class="pt-5 row align-items-end">
            ...
            <div class="order-1 text-center col-lg-4 order-md-2">
                <a href="#" class="text-decoration-none">
                    <img src="<?php echo NEWASIPI_URL; ?>/assets/images/asipi-logo-footer.png" class="img-fluid" width="100"
                        align>
                </a>
            </div>
            <div class="order-3 mt-5 text-center col-lg-4">
                <ul class="social-icons social-icons-big custom-social-icons-style-1">
                    ...
                    <li class="social-icons-linkedin"><a
                            href="https://www.linkedin.com/company/asociaci-n-interamericana-de-la-propiedad-intelectual-asipi-/"
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="py-0 mb-4 col">
                    <p class="mb-0 text-center text-color-light text-3 text-color-grey">ASIPI 2023. Derechos Reservados.
                        Marca Registrada.</p>
                </div>
            </div>
        </div>
