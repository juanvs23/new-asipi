...
require_once __DIR__. '/wp-custom-nav-walker.php';
...
function wp_nav_menu1( $args = array() ) {
	...
	if ( $args->container ) {
		 ...
		 */
		$allowed_tags = apply_filters( 'wp_nav_menu_container_allowedtags', array( '', 'nav' ) );
	...
	_wp_menu_item_classes_by_context1( $menu_items );
	...
	$items .= walk_nav_menu_tree1( $sorted_menu_items, $args->depth, $args );
 ...
 */
function _wp_menu_item_classes_by_context1( &$menu_items ) {
 ...
 */
function walk_nav_menu_tree1( $items, $depth, $args ) {
